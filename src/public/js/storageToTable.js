        ...
        tableContent += `<tr>   
                                ...
                                <td>
                                   <div class="btn-group d-flex gap-2 mb-0">
                                     <button type="button" class="btn btn-primary btn-more" data-bs-toggle="tooltip" data-placement="top" title="See more">
                                      ...
                                      <button type="button" class="btn btn-danger btn-delete" data-bs-toggle="tooltip" data-placement="top" title="Delete">
...
$(document).on("click", ".btn-delete",(e) => {
  e.preventDefault();
  console.log('Clic Evento Botton Delete')
})
